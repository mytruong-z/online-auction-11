...
const ProductDetails = (props) => {
  ...
  return (
    ...
    <div class="section-title m-4">
      ...
      <div className="rom-box">
        <div class="row">
          ...
          <div className="col-8 mt-5">
            Người Bán: <a href="#">Johnny Truong</a>
            
            <p>
              <h3 class="gia-dat">Giá Hiện Tại: 43.000 $</h3>
              <span class="gia-goc">Giá Mua Ngay: 2200 $</span>
            </p>
            <p>Giá Đặt Thấp Nhất: 2200 $</p>
     ...
     <h5><a href="https://www.thegioididong.com/dtdd/samsung-galaxy-z-fold-3-512gb" target="_blank" title="Tham khảo giá điện thoại Samsung Galaxy Z Fold3 5G 512GB chính hãng">Galaxy Z Fold3 5G</a>&nbsp;đánh dấu bước tiến mới của&nbsp;<a href="https://thegioididong.com/samsung" target="_blank" title="Tham khảo sản phẩm Samsung chính hãng tại Thegioididong.com">Samsung</a>&nbsp;trong phân khúc&nbsp;<a href="https://www.thegioididong.com/dtdd" target="_blank" title="Tham khảo giá điện thoại smartphone chính hãng">điện thoại</a>&nbsp;gập cao cấp khi được cải tiến về độ bền cùng những nâng cấp đáng giá về cấu hình hiệu năng, hứa hẹn sẽ mang đến trải nghiệm sử dụng đột phá cho người dùng.</h5>
     <p>Đầu tiên, khung viền Galaxy Z Fold3 được hoàn thiện bằng chất liệu Armor Aluminum cao cấp nhất từ trước đến giờ nhằm tăng cường được độ bền, mà vẫn đảm bảo được trọng lượng cân đối đem tới cảm giác vô cùng chắc chắn và cao cấp.&nbsp;</p>
     <p>Khi không dùng có thể gấp gọn như một cuốn sổ ghi chú nhỏ dễ dàng bỏ túi mang theo bên mình mọi lúc mọi nơi.</p>
     </div>
